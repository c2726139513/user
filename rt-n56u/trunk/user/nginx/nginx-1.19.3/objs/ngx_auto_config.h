#define NGX_CONFIGURE " --prefix=/usr/nginx --with-http_ssl_module --with-pcre=/opt/rt-n56u/trunk/user/nginx/pcre-8.44 --with-zlib=/opt/rt-n56u/trunk/user/nginx/zlib-1.2.11 --with-http_v2_module --without-http_uwsgi_module --without-http_scgi_module --without-http_upstream_zone_module"
